...
TEST(StreamingTest, StreamingBasicStringTest)
{
    ...
    LONGS_EQUAL(5, session.result.data.success->token.count);
}
...
TEST(StreamingTest, StreamingAmbiguousDoubleTest)
{
    ...
    LONGS_EQUAL(6, session.result.data.success->token.count);
}
...
TEST(StreamingTest, StreamingSequenceTest)
{
    ...
    LONGS_EQUAL(11, session.result.data.success->token.count);
}
...
TEST(StreamingTest, StreamingCppCommentTest)
{
    ...
    LONGS_EQUAL(14, session.result.data.success->token.count);
}
