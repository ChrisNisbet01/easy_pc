...
TEST(CombinatorParsersNew, Many_MatchesZeroOccurrences)
{
    ...
    epc_parser_t * p_many_a = epc_many(list, NULL, p_a);
...
{
    epc_parser_t * p_many_null = epc_many(list, NULL, NULL);
...
{
    epc_parser_t * p_a = epc_char(list, NULL, 'a');
    epc_parser_t * p_count_0_a = epc_count(list, NULL, 0, p_a);
...
TEST(CombinatorParsersNew, Between_MatchesCorrectly)
{
    ...
    epc_parser_t * p_close = epc_char(list, NULL, ')');
    epc_parser_t * p_a = epc_char(list, NULL, 'a');
    epc_parser_t * p_between_paren_a = epc_between(list, NULL, p_open, p_a, p_close);
...
TEST(CombinatorParsersNew, Between_FailsNullChildParser)
{
    epc_parser_t * p_open = epc_char(list, NULL, '(');
    epc_parser_t * p_close = epc_char(list, NULL, ')');
    epc_parser_t * p_between_null_wrapped = epc_between(list, NULL, p_open, NULL, p_close);
...
{
    epc_parser_t * p_a = epc_char(list, NULL, 'a');
    epc_parser_t * p_delimited_a = epc_delimited(list, NULL, p_a, NULL);
...
{
    epc_parser_t * p_a = epc_char(list, NULL, 'a');
    epc_parser_t * p_comma = epc_char(list, NULL, ',');
    epc_parser_t * p_delimited_a_comma = epc_delimited(list, NULL, p_a, p_comma);
...
{
    epc_parser_t * p_comma = epc_char(list, NULL, ',');
    epc_parser_t * p_delimited_null_item = epc_delimited(list, NULL, NULL, p_comma);
...
TEST(CombinatorParsersNew, DelimitedFlex_MatchesMultipleItemsWithoutTrailing)
{
    epc_parser_t * p_a = epc_char(list, NULL, 'a');
    epc_parser_t * p_comma = epc_char(list, NULL, ',');
    epc_parser_t * p_delimited_flex = epc_delimited_flex(list, NULL, p_a, p_comma);
...
{
    epc_parser_t * p_a = epc_char(list, NULL, 'a');
    epc_parser_t * p_opt_a = epc_optional(list, NULL, p_a);
...
{
    epc_parser_t * p_opt_null = epc_optional(list, NULL, NULL);
...
{
    epc_parser_t * p_a = epc_char(list, NULL, 'a');
    epc_parser_t * p_look_a = epc_lookahead(list, NULL, p_a);
...
{
    epc_parser_t * p_look_null = epc_lookahead(list, NULL, NULL);
...
{
    epc_parser_t * p_not_null = epc_not(list, NULL, NULL);
...
{
    epc_parser_t * p_fail_msg = epc_fail(list, NULL, "This parser always fails!");
...
{
    epc_parser_t * p_succeed_hello = epc_succeed(list, NULL);
...
{
    epc_parser_t * p_lex = epc_lexeme(list, "lexeme", NULL);
...
{
    epc_parser_t * p_word = epc_string(list, "word", "hello");
    epc_parser_t * p_strip = epc_strip(list, "strip", p_word);
...
{
    epc_parser_t * p_word = epc_string(list, "word", "hello");
    epc_parser_t * p_stripl = epc_stripl(list, "stripl", p_word);
...
{
    epc_parser_t * p_word = epc_string(list, "word", "hello");
    epc_parser_t * p_stripr = epc_stripr(list, "stripr", p_word);
...
{
    epc_parser_t * p_num = epc_int(list, NULL);
    epc_parser_t * p_plus = epc_char(list, NULL, '+');
    epc_parser_t * p_chain = epc_chainl1(list, NULL, p_num, p_plus);
...
TEST(CombinatorParsersNew, ChainL1_MultipleItemsLeftAssociative)
{
    ...
    epc_parser_t * p_chain = epc_chainl1(list, NULL, p_num, p_minus);
...
{
    epc_parser_t * p_num = epc_int(list, NULL);
    epc_parser_t * p_chain = epc_chainl1(list, NULL, p_num, NULL);
    session = parse(p_chain, "1+2");
...
{
    epc_parser_t * p_num = epc_int(list, NULL);
    epc_parser_t * p_caret = epc_char(list, NULL, '^');
    epc_parser_t * p_chain = epc_chainr1(list, NULL, p_num, p_caret);
    session = parse(p_chain, "5");
