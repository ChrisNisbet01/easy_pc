// Generated source for simple_test_language
#include "simple_test_language.h"
#include "simple_test_language_actions.h"
#include <easy_pc/easy_pc.h>
#include <stddef.h>
#include <stdio.h>

epc_parser_t * create_simple_test_language_parser(epc_parser_list * list)
{
    if (list == NULL)
    {
        fprintf(stderr, "Error: Parser list is NULL in create_simple_test_language_parser.\n");
        return NULL;
    }
    ...
    // Rule: SeqGreeting
    epc_parser_t * Seqgreeting = epc_and(list, "Seqgreeting", 2, Greeting, World);

    // Rule: SeqChar
    epc_parser_t * Seqchar = epc_and(list, "Seqchar", 3, Charx, Chary, Charz);
