...
typedef enum epc_ast_user_defined_action_gdl
{
    ...
    GDL_AST_ACTION_CREATE_STRIP_CALL,
    GDL_AST_ACTION_CREATE_STRIPL_CALL,
    GDL_AST_ACTION_CREATE_STRIPR_CALL,
...
typedef enum
{
    ...
    GDL_AST_NODE_TYPE_COMBINATOR_STRIP,
    GDL_AST_NODE_TYPE_COMBINATOR_STRIPL,
    GDL_AST_NODE_TYPE_COMBINATOR_STRIPR,
    GDL_AST_NODE_TYPE_COMBINATOR_SKIP,
    GDL_AST_NODE_TYPE_COMBINATOR_MEMOIZE,
